...
def sort_by_dock_score(glide_files, schr=cs.SCHRODINGER, output="data.txt"):
...
def merge(glide_files, schr=cs.SCHRODINGER, output="results_merge.mae"):
...
def best_poses(glide_file,  schr=cs.SCHRODINGER, output="final_resuts.mae"):
...
def csv_report(glide_file,  schr=cs.SCHRODINGER, properties = ["s_m_title", "r_i_docking_score"],  output="results_all_properties.csv"):
