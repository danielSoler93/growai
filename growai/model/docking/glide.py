...
import subprocess
import growai.model.helpers.formats as fm
...
class Glide_Docker(object):
    ...
    def dock(self, input_file="input.in", schr=cs.SCHRODINGER, host="localhost:1", cpus=1, output="glide_output", precision="SP",
